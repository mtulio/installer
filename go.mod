...
replace (
	...
	github.com/terraform-providers/terraform-provider-aws => github.com/mtulio/terraform-provider-aws v1.60.1-0.20211118010114-e312ed385356 // Pin to openshift fork with tag v3.1.0-gp3-opt2
