...
replace (
	...
	github.com/terraform-providers/terraform-provider-aws => github.com/mtulio/terraform-provider-aws v1.60.1-0.20211111005605-66e1a671ead5 // Pin to openshift fork with tag v2.67.0-openshift-2
