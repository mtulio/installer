...
type VPCSpec struct {
	...
	//
	// When amazon-provided it tries to create in the specified pool defined in publicIpv4Pool,
	...
	// +kubebuilder:default:="amazon-provided"
...
// strategies when assigning IPv4 from Public user-defined pools.
